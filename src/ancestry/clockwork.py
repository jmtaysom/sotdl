...
clockwork_form = [
    "You are a small winged clockwork. Reduce your Health by 5 and your Size to 1/2. You can fly, but you must land "
    "at the end of your movement or fall. You are 3 feet tall and weigh 50 pounds.",
    "You are a small spider-like clockwork with functional hands. Reduce your Size to 1/2. You ignore the effects of "
    "difficult terrain when you climb. You are 3 feet tall and weigh 50 pounds.",
    ...
    "You are a large humanoid clockwork. Increase your Size to 2, but reduce your Speed and your Defense by 2. You "
    "are 10 feet tall and weigh 750 pounds.",
    "You are a large clockwork with the lower body of a horse. Increase your Size to 2 and your Speed by 2. Reduce "
    "your Defense by 3. You are 6 feet long, 6 feet tall, and weigh 750 pounds.",
    ]
...
clockwork_appearance = [
    ...
    ("You have an exquisite body festooned with elaborate etchings and ornamental jewels, and trimmed in precious "
     "metals. If you are dismantled, your body parts are worth {} gc.", 'roll("1d6t")'),
    ]
...
clockwork_background = {
    ...
    2: ("Your soul was plucked from the Underworld before it could forget its former life. Start the game with {} "
        "Insanity and add an extra profession.", "roll('1d6t')"),
    ...
    7: ("Goblins captured you and almost took you apart for scrap materials. You have replaced your missing "
        "components with bits of wood, old weapons, and other rubbish.", 'None'),
...
class Clockwork(Character):
    def __init__(self, s=None):
        ...
        self.appearance = roll_clockwork_appearance(roll('3d6t'))
