...
halfling_appearance = [
    "Luck saved your life, but you did not escape death unscathed. You bear horrific scars, your appearance a mess that evokes revulsion in anyone who lays eyes on you.",
...
halfling_background = {
    1: ("Your curiosity led you to a very dark place, where you witnessed something that unhinged your mind. You start the game with {} Insanity.",  "roll('1d3+1')"),
    ...
    4: ("You stole something of great importance. Someone else took the blame and was executed for the crime.",  'None'),
    5: ("A nasty plague wiped out your community. You were the sole survivor.",  'None'),
    6: ("An orc captured you and kept you as a prisoner for {} years. The orc believed you were a lucky charm.",  "roll('1d6t')"),
    7: ("You went spelunking and became lost until a group of gnomes rescued you.",  'None'),
    8: ("You have terrible wanderlust. You can’t stay put for more than a few weeks at a time. Add one language to the list of the languages you can speak.",  'None'),
    ...
    16: ("One time, an ogre swallowed you whole. Somehow, you survived and came out the other end, filthy but intact.",  'None'),
    17: ("You were abducted by faeries, but you managed to escape.",  'None'),
    18: ("You went on a long journey with a band of dwarfs. You plan to write about your experiences one day.",  'None'),
    19: ("You found an odd treasure in a cave. You start the game with one enchanted object of the GM’s choice.",  'None'),
